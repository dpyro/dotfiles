...
#c.InteractiveShell.banner1 = 'Python 3.5.1 (default, Aug 22 2016, 15:48:23) \nType "copyright", "credits" or "license" for more information.\n\nIPython 5.1.0 -- An enhanced Interactive Python.\n?         -> Introduction and overview of IPython\'s features.\n%quickref -> Quick reference.\nhelp      -> Python\'s own help system.\nobject?   -> Details about \'object\', use \'object??\' for extra details.\n'
...
## The name of a Pygments style to use for syntax highlighting:  emacs, borland,
#  murphy, tango, algol, paraiso-light, manni, paraiso-dark, pastie, colorful,
#  autumn, lovelace, trac, vim, algol_nu, default, xcode, rrt, fruity, vs,
#  monokai, bw, igor, friendly, perldoc, native
